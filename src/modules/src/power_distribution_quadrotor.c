...
void powerDistribution(motors_thrust_t* motorPower, const control_t *control)
{
  ...
  // motorPower->m3 = limitThrust(control->thrust_2);
  // motorPower->m4 = limitThrust(control->thrust_3); // 3 wings

  
  motorPower->m1 = limitThrust(control->thrust);
  motorPower->m2 = limitThrust(control->thrust_2);   
  motorPower->m3 = limitThrust(control->thrust_3);
  motorPower->m4 = limitThrust(control->thrust_4); // 4 wings 
